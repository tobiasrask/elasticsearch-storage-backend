...
var ElasticsearchStorageHandler = function (_EntityStorageHandler) {
  ...
  */
  function ElasticsearchStorageHandler(variables) {
    ...
    if (variables.hasOwnProperty('indexName')) _this._registry.set('properties', 'indexName', variables.indexName);
  ...
  _createClass(ElasticsearchStorageHandler, [{
    ...
    */
    ...
    value: function getStorageIndexName() {
      return this.getStorageIndexPrefix() + this._registry.get('properties', 'indexName', this.getEntityTypeId());
    }
